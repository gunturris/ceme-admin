...
if (!defined('__CLASS_HTML2PDF__'))
{
	...
	require_once(MY_COMPONENT_PATH.'__report/_mypdf/mypdf.class.php');	// classe mypdf dérivé de fpdf de Olivier PLATHEY 
	require_once(MY_COMPONENT_PATH.'__report/parsingHTML.class.php');	// classe de parsing HTML
	require_once(MY_COMPONENT_PATH.'__report/styleHTML.class.php');		// classe de gestion des styles
