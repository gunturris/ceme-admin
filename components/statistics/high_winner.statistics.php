...
function list_statistic_high_winner_player(){
...
function high_winner_tabs($player_id , $page){
     my_set_file_js(
		array(
    ...
    $navigasi = array(
		'<input class="submit-green" type="button" value="By Player" onclick="javascript:location.href=\'index.php?com='.$_GET['com'].'&task=high_winner&subtask=player\'"/>',
		'<input class="submit-green" type="button" value="By Dates" onclick="javascript:location.href=\'index.php?com='.$_GET['com'].'&task=high_winner&subtask=total\'"/>' 
	);
    ...
    switch($page){
        case "total"  :
            $view .= list_statistic_high_winner( $player['username'] );
        break;
        case "player"  :
            $view .= list_statistic_high_winner_player();
        break; 
        default:
            $view .= list_statistic_high_winner( 0 );
        break;
